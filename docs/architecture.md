...
| `DaVinciBot/shared-workflows@v6.1.3`             | `ci.yml`, `container.yml`, `deploy.yml`, `security-scan.yml`     |
...
| `DaVinciBot/shared-workflows@v6.1.3`              | le déclenchement Watchtower, les tags et la sonde y sont déjà encodés ; les réécrire garantissait la dérive |
