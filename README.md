...
Micro-service HTTP mono-endpoint : à chaque cotisation payée sur HelloAsso, il coche la case « cotisation payée » sur la
...
HelloAsso ──notification──▶ POST /webhook/<secret>
                                 ...
                                 ├─ 3. recherche par email     API Notion
                                 ├─ 4. case cochée             API Notion
                                 └─ 5. mémorisé                Supabase
```
...
- [`.github/workflows/`](.github/workflows) — appellent `DaVinciBot/shared-workflows@v6.1.0`
