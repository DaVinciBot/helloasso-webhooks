...
import type { EmailPropertyType, NotionConfig } from '../core/config.js';
import { DataError, TransientError } from '../core/errors.js';
import { normalizeEmail, normalizeName } from '../core/identity.js';

/**
 * Adaptateur Notion : recherche de la ligne du membre, puis pose l'état
 * « cotisation payée » et le montant revenu à l'association.
 *
...
/** Ce qu'on sait du membre, par ordre de priorité d'appariement. */
