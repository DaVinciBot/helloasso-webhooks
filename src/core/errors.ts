 ...
 * - {@link DataError} → 200 : la donnée est incohérente (membre inconnu de
 *   Notion, commande sans participant identifiable). Rejouer ne changera rien ;
 *   il faut une action humaine, donc on accuse réception et on alerte.
 * - {@link ConfigError} → jetée au démarrage uniquement, le process refuse de
 *   se lancer.
 */
